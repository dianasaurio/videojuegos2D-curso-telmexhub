...
Q.loadTMX(recursos, function() {
	...
	//Compilar sprites para las tuberías
	Q.compileSheets("tuberias.png", "tuberias.json");
	
	//alternativa para no hacer el .json
